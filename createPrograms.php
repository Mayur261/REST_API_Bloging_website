...
if (isset($_SESSION['username'])) {
    ...
    $sql = "SELECT topic FROM topic WHERE username = ? AND Category = 'Programs'";
    $stmt = $conn->prepare($sql);
    ...
    <?php include 'sidebar.php'; ?>
        ...
        <div class="page-content">
            <div class="admin-container">
                <form action="addPrograms.php" method="post"  class="admin-form md-box" enctype="multipart/form-data">
