...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT title, body, topic, image FROM development WHERE id = ?";
    ...
    <?php include 'sidebar.php'; ?>
        ...
        <div class="page-content">
            <div class="admin-container">
                <form action="updateDevelopment.php" method="post" class="admin-form md-box" enctype="multipart/form-data">
